function params = GeneratePSF(params)
    %

    params.PSF = generate_PSF(params.imsize, params.pupil_size,...
        params.pupil_size, params.field_size, params.lambda, ...
        params.diff_limited, params.defocus);
