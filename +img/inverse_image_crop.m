function old_coordinates_x_y = inverse_image_crop(img_orig, img_cropped, rect, new_coordinates)
...
old_coordinates_row_col(:,2) = x_crop(sub2ind((size_cropped),new_coordinates(:,1),new_coordinates(:,2)));
old_coordinates_row_col(:,1) = y_crop(sub2ind((size_cropped),new_coordinates(:,1),new_coordinates(:,2)));
