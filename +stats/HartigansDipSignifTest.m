...
function		[dip, p_value, xlow,xup, f]=HartigansDipSignifTest(xpdf,nboot)
...
%
% http://www.ringachlab.net/lab/Data_files/hartigansdipsigniftest.m

% calculate the DIP statistic from the empirical pdf
[dip,xlow,xup, ifault, gcm, lcm, mn, mj]=stats.HartigansDipTest(xpdf);
N=length(xpdf);
...
for i=1:nboot
   ...
   [unif_dip]=stats.HartigansDipTest(unifpdfboot);
